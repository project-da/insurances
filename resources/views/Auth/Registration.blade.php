...
<body>
    ...
    <div class="container d-flex justify-content-center">
        <div class="d-flex flex-column justify-content-between">
            ...
            <form action="{{url('postRegistration')}}" method="Post">
                @csrf
                <div class="card two bg-white px-5 py-4 mb-3">
                    ...
                    <button class="btn btn-primary btn-block btn-lg mt-1 mb-2" type="submit">
                        <a href="login"><span>Register<i class="fas fa-long-arrow-alt-right ml-2"></i>
                            </span></a></button>
                    ...
                    <div class="form-group" style="text-align:center">
                        <a href="login"  style="color:red">LoginHere</a>
                    </div>
                </div>
        </div>
    </div>
